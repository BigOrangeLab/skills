...
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [content-pull](skills/content-pull/)                               | Pull all public content from a WordPress site via the REST API and save as Markdown, HTML, or Word files. Use when an agent needs to ingest, archive, process, or round-trip-edit WordPress post content programmatically.                                                                                                     | 2026-06-04<br>`Node.js 18+`                                                   | _static_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| [newspack](skills/newspack/)                                       | Build, configure, and maintain Newspack-powered WordPress news sites. Covers onboarding, themes, revenue, engagement, analytics, and migration.                                                                                                                                                                                | 2026-08-12<br>`NP 6.42.1` · `WP 7.0.4`                                        | [![Newspack](https://img.shields.io/github/v/release/Automattic/newspack-plugin?label=newspack&style=flat-square)](https://github.com/Automattic/newspack-plugin/releases)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| [wp-plugin-directory-review](skills/wp-plugin-directory-review/)   | Review a WordPress plugin's code against the WordPress.org Plugin Directory Guidelines before submission or when addressing review team feedback. Covers all 18 guidelines, Block Directory rules, and common reviewer shorthand phrases.                                                                                      | 2026-06-10<br>_static_ (guidelines)                                           | _static_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [cove](skills/cove/)                                               | Spin up and manage local WordPress (and static) sites with the Cove CLI — automatic HTTPS, one-click admin login, shared MariaDB, Mailpit, no Docker. Use when an agent needs a fast local WordPress dev site on macOS, Linux, or WSL2.                                                                                        | 2026-06-18<br>`cove 1.10`                                                     | [![cove](https://img.shields.io/github/v/release/anchorhost/cove?label=cove&style=flat-square)](https://github.com/anchorhost/cove/releases)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [playground-dev-env](skills/playground-dev-env/)                   | Spin up a disposable local WordPress dev environment with `@wp-playground/cli` (no Docker/MySQL/Apache) using the `start` command — the drop-in replacement for the deprecated wp-now. Covers version pinning, blueprints, mounts, and migration.                                                                              | 2026-06-18<br>`@wp-playground/cli 3.1.39`                                     | [![@wp-playground/cli](https://img.shields.io/npm/v/@wp-playground/cli?label=%40wp-playground%2Fcli&style=flat-square)](https://www.npmjs.com/package/@wp-playground/cli)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [wp-7-1-upgrade](skills/wp-7-1-upgrade/)                           | Audit and update a WordPress codebase for 7.1: the always-iframed post editor, removed `@wordpress/components` APIs, moved list-table row headers, jQuery UI 1.14.2, changed filter defaults, plus adoption of the SVG Icon, tooltip, Abilities, and style-state APIs. Includes a grep-based audit script.                     | 2026-08-12<br>`WP 7.1` · `Gutenberg 23.6` · `wp-components 33.1.0`            | [![WordPress](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.wordpress.org%2Fcore%2Fversion-check%2F1.7%2F&query=%24.offers%5B0%5D.current&label=WordPress&style=flat-square)](https://wordpress.org/news/category/releases/) [![wp-components](https://img.shields.io/npm/v/@wordpress/components?label=wp-components&style=flat-square)](https://www.npmjs.com/package/@wordpress/components)                                                                                                                                                                                                                                                                                                                                               |
| [google-ads-js](skills/google-ads-js/)                             | Implement Google Ads JavaScript integrations: gtag.js conversion tracking, remarketing, enhanced conversions, Consent Mode v2, and programmatic campaign management via the Google Ads REST API.                                                                                                                               | 2026-06-22<br>`Google Ads API v22`                                            | _static_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [harvest-clickup-reconcile](skills/harvest-clickup-reconcile/)     | Audit Harvest time entries against the ClickUp tasks their notes reference, to catch time billed to the wrong client. Resolves each task's folder/list, maps it to a client, and reports mismatches plus the entries it could not verify.                                                                                      | 2026-08-25<br>`Harvest API v2` · `ClickUp API v2` · `PHP 8.1+`                | _static_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [wp-importing](skills/wp-importing/)                               | Build a custom, one-off migration that pulls content from a headless CMS export, legacy database, CSV/JSON dump, or another site into WordPress. Covers source profiling, content-model mapping, an idempotent resumable import script, `WP_IMPORTING` side-effect suppression, throttling, media, and the production runbook. | 2026-08-25<br>`WP 7.1` · `wp-cli 2.12.0`                                      | [![WordPress](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.wordpress.org%2Fcore%2Fversion-check%2F1.7%2F&query=%24.offers%5B0%5D.current&label=WordPress&style=flat-square)](https://wordpress.org/news/category/releases/) [![wp-cli](https://img.shields.io/github/v/release/wp-cli/wp-cli?label=wp-cli&style=flat-square)](https://github.com/wp-cli/wp-cli/releases)                                                                                                                                                                                                                                                                                                                                                                    |
| [enfold-alb](skills/enfold-alb/)                                   | Build, edit, and programmatically generate content for the Enfold theme's Avia Advanced Layout Builder. Covers the full shortcode element catalog, nesting rules, ALB post meta, custom elements, Custom Element Templates, and dynamic content.                                                                               | 2026-08-26<br>`Enfold 7.1.6`                                                  | _static_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
